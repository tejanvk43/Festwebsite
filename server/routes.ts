    ...
    const stalls = [
      {
        ...
        name: "Food Fiesta",
        type: "food",
        description: "Multi-cuisine food court with vegetarian and non-vegetarian counters, quick bites and desserts.",
        owner: "Campus Catering Services",
        booth: "F1-F8",
        location: "food-court",
        items: ["Pizza slices", "Masala Dosas", "Chaat", "Dessert Shots"],
        priceRange: "₹50-₹300",
        openingHours: [
          { day: "2026-02-14", open: "10:00", close: "22:30" },
          { day: "2026-02-15", open: "09:00", close: "23:00" },
          { day: "2026-02-16", open: "09:00", close: "18:00" }
        ],
        contact: { phone: "+91-90000-11111", email: "food@usharamafest.edu" },
        image: "/assets/stalls/food-fiesta.png"
      },
      {
        id: "stall-002",
        name: "Merch Hub",
        type: "merch",
        description: "Official fest T-shirts, pixel pins, stickers and hoodies.",
        owner: "Fest Merch Co.",
        booth: "M1",
        location: "open-ground",
        items: ["T-shirts", "Hoodies", "Mugs", "Pins", "Stickers"],
        priceRange: "₹100-₹1500",
        openingHours: [
          { day: "2026-02-14", open: "11:00", close: "21:00" },
          { day: "2026-02-15", open: "10:00", "close": "22:00" }
        ],
        contact: { phone: "+91-90000-22222", email: "merch@usharamafest.edu" },
        image: "/assets/stalls/merch-hub.png"
      },
      {
        id: "stall-003",
        name: "Tech Demos",
        type: "exhibition",
        description: "Student & startup demo booths showcasing AR, robotics, AI projects.",
        owner: "CSE Department",
        booth: "T1-T6",
        location: "tech-avenue",
        items: ["AR demo", "Mini robots", "Live coding demos"],
        priceRange: "Free",
        openingHours: [
          { day: "2026-02-14", open: "10:00", close: "18:00" },
          { day: "2026-02-15", open: "10:00", "close": "18:00" }
        ],
        contact: { phone: "+91-90000-33333", email: "techdemos@usharamafest.edu" },
        image: "/assets/stalls/tech-demos.png"
      },
      {
        id: "stall-004",
        name: "Gaming Zone (retail)",
        type: "retail",
        description: "Gaming peripherals, consoles and merch from local vendors.",
        owner: "GameStore",
        booth: "G1",
        location: "gaming-hut",
        items: ["Headsets", "RGB Keyboards", "Controllers"],
        priceRange: "₹800-₹12000",
        openingHours: [
          { day: "2026-02-14", open: "12:00", "close": "22:00" }
        ],
        contact: { phone: "+91-90000-44444", email: "gaming@vendors.com" },
        image: "/assets/stalls/gaming-zone.png"
      },
      {
        id: "stall-005",
        name: "Sponsor: RedByte Labs",
        type: "sponsor",
        description: "Interactive sponsor booth with giveaways and quick quizzes.",
        owner: "RedByte Labs",
        booth: "S1",
        location: "sponsor-avenue",
        items: ["Giveaways", "Mini quizzes", "Internship sign-ups"],
        priceRange: "Free",
        openingHours: [
          { day: "2026-02-14", open: "10:00", "close": "22:00" },
          { day: "2026-02-15", open: "10:00", "close": "22:00" }
        ],
        contact: { phone: "+91-90000-55555", email: "partners@redbyte.com" },
        image: "/assets/stalls/redbyte.png"
      },
      {
        id: "stall-006",
        name: "College Clubs Info",
        type: "info",
        description: "Stalls for student clubs: Robotics, Cultural, IIT-Prep and more.",
        owner: "Student Affairs",
        booth: "C1-C10",
        location: "club-zone",
        items: ["Sign-ups", "Info brochures", "Mini demos"],
        priceRange: "Free",
        openingHours: [
          { day: "2026-02-14", open: "09:00", "close": "18:00" },
          { day: "2026-02-15", open: "09:00", "close": "18:00" }
        ],
        contact: { phone: "+91-90000-66666", email: "clubs@usharama.edu" },
        image: "/assets/stalls/clubs-info.png"
      }
    ];
